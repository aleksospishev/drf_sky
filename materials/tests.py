...
class LessonTestCase(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.course_sub = Subscription.objects.create(user = self.user, course=self.course)
    ...
    def test_lesson_create(self):
        ...
        data = {'name': 'test_lesson_2', 'course':self.course.pk, 'video_url': 'https://youtube.com/1234/', 'owner': self.user.pk}
